...
\begin{itemize}
    \item ALeRCE: Automatic Learning for the Rapid Classification of Events
    \item AMPEL: Alert Management, Photometry, and Evaluation of Light Curves
    \item ANTARES: Arizona-NOIRLab Temporal Analysis and Response to Events System
    \item Babamul
    \item Fink
    \item Lasair
    \item Pitt-Google
