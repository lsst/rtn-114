...
Seven community alert brokers were selected through a proposal process \eric{cite} to receive the full alert stream directly from the USDF (\S \ref{sec:brokers}).
