...
In recent years, scientists have conducted dedicated optical time-domain surveys with large CCD mosaic cameras (e.g., PanSTARRS, DECam, ZTF, HSC, Gaia, Kepler, TESS, WFST) as well as networks of multiple telescopes (e.g., ASAS-SN, ATLAS, KMT-Net, GOTO, BlackGEM, Everyscope, LAST  \eric{cites}).
These have yielded large new samples of supernovae, variable stars, active galactic nuclei, and solar system objects.
Additionally, they have uncovered the first exemplars of rare new classes of objects including kilonovae, Fast Blue Optical Transients (FBOTS), interstellar objects, and more. \eric{cites}
...
The Legacy Survey of Space and Time (LSST) to be conducted by the Vera C.\ Rubin Observatory \citep{2019ApJ...873..111I} promises an order of magnitude increase in transient discovery.
